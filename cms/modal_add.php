...
<table class="table1">
	...
	<tr>
		<td><label id="description"style="color:#3a87ad; font-size:18px;height=100px;">Description</label></td>
		<td width="30"></td>
	...
	<input type="hidden" name="gallery_id" value="<?php echo $_REQUEST["gallery"] ;?>" placeholder="Title" required />
</table>
    </div>
