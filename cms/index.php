...
//                                
							...
							<a href="delete.php?tbl_image_id=<?php echo $id; ?>&gallery_id=<?php echo $gallery_id; ?>" class="btn btn-danger">Yes</a>
							</div>
							</div>
							</div>
										<!-- Modal Update Image -->
							...
							<?php endif; ?>
							<form action="edit_PDO.php<?php echo '?tbl_image_id='.$id; ?>&gallery_id=<?php echo $gallery_id; ?>" method="post" enctype="multipart/form-data">
